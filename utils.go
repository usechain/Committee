...
const (
	DefaultMinumumStr = "15792089237316195423570985008687907853269984665640564039457584007913129639747"
)
...
func random() *big.Int {
	...
	minmumRandom, _ := big.NewInt(0).SetString(DefaultMinumumStr, 10)
